...
public class MergePsortbWorkflowAction extends B2GAction<MergePsortbWorkflowMetadata> {
	...
	@Override
	public Class<MergePsortbWorkflowMetadata> jobMetadataClass() {
		return MergePsortbWorkflowMetadata.class;
	}
